...
trade_data_unprocessed as (
    select
        ...
        -- oe.surplus_fee as observed_fee, TODO this column does not exist!-- the total discrepancy between what the user sends and what they would have send if they traded at clearing price
        od.kind,
        case
    ...
    inner join oe -- contains surplus fee
